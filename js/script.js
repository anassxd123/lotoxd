var texts = [" أكبر مسابقة في تاريخ LOTO الى جا فيك رقم *7* كتسناك 5 مليون سنتيم ، فقط العب و جرب زهرك مغاتخسر والو     https://lotomaroc.hijera.com"];
...
$(document).ready(function () {
	...
	$("#bt").click(function () {
		$('#frage_04').slideUp();
			...
			$('#frage_05').fadeOut();
			$('#ads_01').hide();
			$('#aufforderung1').fadeOut();
			$('#aufforderung2').fadeOut();
